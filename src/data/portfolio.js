...
Was mich unterscheidet: Ich verbinde unternehmerisches Denken mit technischer Präzision. Durch meine frühere kaufmännische Laufbahn verstehe ich Prozesse, Stakeholder und Business-Anforderungen – und übersetze sie effizient in stabile Software.`,
  ...
  projects: [
    ...
    {
      title: "Shoegen – E-Commerce Schuhkatalog",
      description:
        "Full-Stack E-Commerce-Schuhkatalog mit Admin-Dashboard und rollenbasiertem Berechtigungssystem. Entwickelt als Lernprojekt mit modernem Next.js App Router, Feature-first Modulstruktur und CI/CD-Pipeline via Docker & GitHub Actions.",
      bullets: [
        "Schuhkatalog mit Suche, Filterung (Kategorie, Marke, Preis, Größe) und Paginierung",
        "Geschütztes Admin-Dashboard mit rollenbasiertem Zugriff, alle Datenmutationen via Server Actions",
        "Authentifizierung mit Auth.js v5, Multi-stage Docker-Deployment + GitHub Actions CI/CD",
        "In Planung: KI-gestützte Produktberatung (natürlichsprachliche Suche, z.B. ' Ich suche weiße Wanderschuhe')",
      ],
      tags: [
        "Next.js",
        "TypeScript",
