...
function DockIcon({
  ...
  return (
    <div className="flex flex-col items-center group relative">
      <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-[11px] font-medium text-white bg-black/70 rounded px-1.5 py-0.5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
        {label}
      </span>
      <motion.button
        onClick={onClick}
        ...
        style={{
          ...
          boxShadow: active ? "0 4px 12px rgba(74,127,193,0.6)" : "0 2px 8px rgba(0,0,0,0.2)",
          border: active ? "1px solid rgba(255,255,255,0.5)" : "1px solid rgba(255,255,255,0.4)",
        }}
      >
...
export default function Dock({ active, onSelect, windowOpen, onOpenWindow }: Props) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        {/* Divider */}
        <div
          className="self-stretch mx-1 my-1"
